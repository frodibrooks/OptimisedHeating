...
def extract_junctions_and_reservoirs(features):
    ...
    #Within properties of the junctions in the geojson is "DEMAND", which needs to be added to the junction list 


    #     if start.startswith('Junction'):
    #         # print(junctions)
    #         junctions.add(start)
    #     else:
    #         reservoirs.add(start)
    #         if feature['geometry']['type'] == 'LineString':
    #             coordinate = feature['geometry']['coordinates']
    #             if start not in coordinates:
    #                 coordinates[start] = coordinate[0]

    #     if end.startswith('Junction'):
    #         junctions.add(end)
    #         if feature['geometry']['type'] == 'LineString':
    #             coordinate = feature
    #             if end not in coordinates:
    #                 coordinates[end] = coordinate[1]
    #     else:
    #         reservoirs.add(end)
    #         if feature['geometry']['type'] == 'LineString':
    #             coordinate = feature['geometry']['coordinates']
