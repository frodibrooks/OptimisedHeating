...
class Agent:
    def __init__(self, state_size, action_size, seed=0):
        ...
        self.epsilon_decay = 0.99993  # hversu hratt epsilon minnkar
...
if __name__ == "__main__":
    ...
    reward_log_path = "/Users/frodibrooks/Desktop/DTU/Thesis/OptimisedHeating/AgentV2/training_results/reward_log_agent302.csv"
    ...
    torch.save(agent.policy_net.state_dict(), "trained_model_vol302.pth")
    print()
    print("Model saved!")