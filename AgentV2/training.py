...
class Agent:
    def __init__(self, state_size, action_size, seed=0):
        ...
        self.epsilon_decay = 0.99983  # hversu hratt epsilon minnkar
...
if __name__ == "__main__":
    num_episodes = 22500  # You can now train for more episodes since they're fast
    # reward_log_path = r"C:\Users\frodi\Desktop\OptimisedHeating\AgentV2\training_results\reward_log_agent15.csv"
    reward_log_path = "/Users/frodibrooks/Desktop/DTU/Thesis/OptimisedHeating/AgentV2/training_results/logs/reward_log_agent407.csv"
    ...
    torch.save(agent.policy_net.state_dict(), "trained_model_vol407.pth")
    print()
    print("Model saved!")