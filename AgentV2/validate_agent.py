...
demand_ptr = np.array([1.3 , 0.8 , 1, 1.2, 1.1])
env = WdsWithDemand(
...
model.load_state_dict(torch.load("trained_model_vol23.pth"))
model.eval()
...
print("Validation complete. Results saved to validation_full_log_agent23.csv.")
