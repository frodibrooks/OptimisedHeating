...
model.load_state_dict(torch.load("trained_model_vol104.pth"))
model.eval()
...
os.chdir(save_path)
df.to_csv("validation_full_log_agent104.csv", index=False)

print("Validation complete. Results saved to validation_full_log_agent104.csv.")
