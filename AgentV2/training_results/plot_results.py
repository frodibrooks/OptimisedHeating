...
def plot_rewards_from_csv(csv_file, save_path="reward_plot.png"):
    ...
    full_save_path = os.path.join(save_path, "reward_plot_agent17.png")
...
if __name__ == "__main__":
    ...
    csv_file = "/Users/frodibrooks/Desktop/DTU/Thesis/OptimisedHeating/AgentV2/training_results/reward_log_agent17.csv"
